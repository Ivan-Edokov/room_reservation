"""
Здесь вы напишете «ручку», которая будет запускать
процесс сбора информации из базы данных
и формирования отчёта в гугл-таблице.
Первым делом добавьте в файл импорты:
"""
